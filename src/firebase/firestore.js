...
export const getInvoices = () => getCollection('invoices');
export const addInvoice = (data) => addData('invoices', data);
export const updateInvoice = (id, data) => updateData('invoices', id, data);
